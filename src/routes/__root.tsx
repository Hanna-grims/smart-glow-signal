...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "VC-Lane" },
      { title: "VC-Lane — Traffic Monitoring & Signal Control" },
      {
        name: "description",
        content:
          "Mobile operator app for the VC-Lane Adaptive Traffic Monitoring and Signal Control System.",
      },
      { property: "og:title", content: "VC-Lane Traffic Monitoring" },
      {
